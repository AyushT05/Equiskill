...
import { ImageKitData, Resource, Section } from "@prisma/client";
...
interface EditSectionFormProps {
    section: Section & { resources: Resource[]; imageKitData?: ImageKitData | null }; // Updated type here
    courseId: string;
        ...
        <>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 mt-5">
                    ...
                    {section.imageKitData?.assetUrl && (
                        <div className="my-5">
                            <video controls className="md:max-w-[600px]">
                                <source src={section.imageKitData.assetUrl} type="video/mp4" />
