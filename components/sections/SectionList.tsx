              ...
              >
                {(provided) => (
                  <div
                    ...
                    ref={provided.innerRef}
                    className="flex items-center bg-[#cce6ff] rounded-lg text-sm font-medium p-3"
                  >
                    <div {...provided.dragHandleProps}>
                      <Grip className="h-4 w-4 cursor-pointer mr-4 hover:text-[#003cb3]" />
                    </div>
                    {section.title}
                    <div className="ml-auto">
                      <Pencil
                        className="h-4 w-4 cursor-pointer hover:text-[#003cb3]"
