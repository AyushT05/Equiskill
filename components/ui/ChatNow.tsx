...
const ChatNow = ({ instructorEmail }: ChatNowProps) => {
  ...
  return (
    <StyledWrapper>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Chat with your Instructor</DialogTitle>
            <DialogDescription>
              {instructorEmail
                ? `Send a request to ${instructorEmail} to be able to chat with your instructor.`
                : "No email available for this instructor."}
            </DialogDescription>
          </DialogHeader>

          <DialogFooter>
            <button onClick={handleSendMessage} className="btn-primary">Understood</button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </StyledWrapper>
